...
#from . import views
from .views import HomeView, ArticleDetailView, AddPostView, UpdatePostView, DeletePostView, LikeView, DislikeView, AddCategoryView, AddCommentView, AddAuthorView
